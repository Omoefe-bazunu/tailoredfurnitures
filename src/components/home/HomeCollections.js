          ...
          <div className="premium-frame bg-card flex flex-col group overflow-hidden shadow-lg border border-foreground/5">
            ...
            <div className="p-8 flex flex-col gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 font-body text-[10px] tracking-widest uppercase font-semibold pt-2 text-foreground group-hover:text-primary transition-colors w-fit"
              >
                Enter Exhibition{" "}
